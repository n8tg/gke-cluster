...
variable "gke_primary_node_type" {
  default     = "e2-micro"
  description = "node type for compute nodes"
}

variable "gke_primary_nodepool_preemptable" {
  description = "enable preemption on default nodepool"
  default     = true
}

variable "gke_primary_nodepool_disk_type" {
  description = "disk type of default nodepool"
  default     = "pd-balanced"
}

variable "gke_primary_nodepool_disk_size_gb" {
